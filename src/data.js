...
export const CROPS = {
  ...
  testing_suite: { name: { 'pt-BR': 'Suite de Testes', en: 'Testing Suite' }, emoji: '🧪', sym: 'test()', t: 360, y: 1280, cost: 260, color: '#f59e0b', rarity: 'epic', lv: 12, desc: { 'pt-BR': 'Confiança para crescer sem quebrar.', en: 'Confidence to grow without breaking.' } },
  ...
  orchestrator: { name: { 'pt-BR': 'Orquestrador', en: 'Orchestrator' }, emoji: '🛰️', sym: 'orchestrate()', t: 760, y: 5200, cost: 1250, color: '#14b8a6', rarity: 'mythic', lv: 18, desc: { 'pt-BR': 'Escala tudo sem pedir permissão.', en: 'Scales everything without asking permission.' } },
...
export const CONTRACT_POOL = [
  ...
  { id: 'quality_gate', name: { 'pt-BR': 'Quality Gate', en: 'Quality Gate' }, emoji: '🧪', desc: { 'pt-BR': 'Colha 20 Suite de Testes', en: 'Harvest 20 Testing Suites' }, goal: 20, key: 'testHarv', rewardTok: 240, rewardXp: 150, rewardRep: 2 },
  { id: 'scale_out', name: { 'pt-BR': 'Scale Out', en: 'Scale Out' }, emoji: '🛰️', desc: { 'pt-BR': 'Colha 8 Orquestradores', en: 'Harvest 8 Orchestrators' }, goal: 8, key: 'orchHarv', rewardTok: 340, rewardXp: 220, rewardRep: 3 },
...
export const GOALS = [
  ...
  { id: 'lvl25', name: { 'pt-BR': 'Deploy em escala', en: 'Scale Deployment' }, desc: { 'pt-BR': 'Alcance o nível 25', en: 'Reach level 25' }, key: 'level', goal: 25, reward: { prestige: 1, tokens: 600 } },
  ...
  { id: 'testing50', name: { 'pt-BR': 'Sem regressão', en: 'No Regression' }, desc: { 'pt-BR': 'Colha 50 Suite de Testes', en: 'Harvest 50 Testing Suites' }, key: 'testHarv', goal: 50, reward: { reputation: 3, prestige: 1 } },
...
export const ACHIEVEMENTS = [
  ...
  { id: 'tester', name: { 'pt-BR': 'Quality Owner', en: 'Quality Owner' }, emoji: '🧪', desc: { 'pt-BR': 'Colha 25 Suite de Testes', en: 'Harvest 25 Testing Suites' }, chk: state => state.stats.testHarv >= 25 },
  { id: 'scale', name: { 'pt-BR': 'Platform Lead', en: 'Platform Lead' }, emoji: '🛰️', desc: { 'pt-BR': 'Colha 10 Orquestradores', en: 'Harvest 10 Orchestrators' }, chk: state => state.stats.orchHarv >= 10 },
